...
from PyQt5.QtGui import QMouseEvent, QColor, QPaintEvent, QMovie, QPainter, QCursor, QResizeEvent, QShowEvent
from PyQt5.QtWidgets import QDialog, QFrame, QVBoxLayout, QLabel, QHBoxLayout, QSizePolicy, QGraphicsDropShadowEffect, qApp
...
class UiDialogTitleBar(QFrame):
    ...
    def __init__(self, title: str, parent: UiDialogBase):
        super().__init__(parent)

        self.setCursor(Qt.ArrowCursor)

        self.parent_dialog: UiDialogBase = parent
